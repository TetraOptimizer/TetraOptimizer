...
$tests = @(
    ...
    [PSCustomObject]@{ File='Invoke-TetraDuplicateExecutionSafetyTests.ps1'; ExpectedTests=24 },
    [PSCustomObject]@{ File='Invoke-TetraExecutionBackupIntegrationTests.ps1'; ExpectedTests=8 },
